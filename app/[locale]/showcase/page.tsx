      ...
      <main className="echelon-side-rails min-h-[calc(100vh-4rem)]">
        <section className="relative overflow-hidden border-b border-border">
          ...
          <div className="relative mx-auto max-w-4xl px-6 py-20 sm:px-8">
            <h1 className="text-3xl font-semibold tracking-tight">{isPtBr ? "Vitrine" : "Showcase"}</h1>
            <p className="mt-3 text-muted-foreground">
              {isPtBr
                ? "A página de Vitrine está em construção. Em breve listaremos cases e projetos em destaque."
